          ...
          <Col xs={12} md={6} xl={7} className=" lg:col-span-2">
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1 className="text-red-50  z-50">{`Hi! I'm Judy`} </h1> <h1 className="text-red-50 bg-gradient-to-r  from-fuchsia-950 to-white bg-clip-text text-transparent z-50"><span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Web Designer", "UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
